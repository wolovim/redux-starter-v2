...
The Facebook team has offered up its opinionated configuration settings, and I happen to like (most of)
those opinions. Read more about `create-react-app` [here](https://facebook.github.io/react/blog/2016/07/22/create-apps-with-no-configuration.html).

Another significant change is the use of [Jest](https://facebook.github.io/jest/), replacing the previous
testing suite. Jest has [vastly improved](https://twitter.com/omgwtfmarc/status/776197855241310208) and is
